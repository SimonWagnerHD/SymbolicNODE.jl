...
writedlm(string("../data/genetic_node_cat_train",epochs,".csv"), train_losses, ',')
writedlm(string("../data/genetic_node_cat_valid",epochs,".csv"), valid_losses, ',')
save_ANN(re_nn(model.p), string("../models/genetic_node_cat",epochs,".bson"))