...
train_losses, valid_losses = train_NODE(model, train_data, epochs; loss=pendulum_loss, valid_data=train_data, re_nn=re_nn, η=1f-3, decay=1f-6, print_every=5, save_every=50)
